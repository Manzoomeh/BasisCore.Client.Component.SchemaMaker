...
class HTMLFieldType extends QuestionPart {
    constructor(part, owner, answer) {
        ...
        this.owner._addButton.removeEventListener("click", this.owner.onAddBtnClick);
        this.owner._removeButton.removeEventListener("click", this.owner.onRemoveBtnClick);
